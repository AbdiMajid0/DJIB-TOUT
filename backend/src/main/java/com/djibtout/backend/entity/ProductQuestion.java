...
public class ProductQuestion {
 ...
 @ManyToOne(fetch=FetchType.EAGER,optional=false) @JoinColumn(name="user_id") @JsonIncludeProperties({"id","name"}) private User user;
 ...
 @ManyToOne(fetch=FetchType.EAGER) @JoinColumn(name="answered_by_id") @JsonIncludeProperties({"id","name"}) private User answeredBy;
