...
public class AddressController {
 ...
 private void apply(Address x,AddressRequest r){x.setLabel(r.label);x.setFullAddress(r.fullAddress);x.setCity(r.city);x.setPhone(r.phone);x.setDeliveryInstructions(r.deliveryInstructions);x.setDefault(r.isDefault);}
 ...
 static class AddressRequest{@NotBlank @Size(max=80) public String label;@NotBlank @Size(max=500) public String fullAddress;@NotBlank @Size(max=100) public String city;@Size(max=30) public String phone;@Size(max=500) public String deliveryInstructions;public boolean isDefault;}
}
